...
/**
 * Servlet implementation class ToGuWenChaXunServlet
 */
@WebServlet("/ToGuWenChaXunServlet")
public class ToGuWenChaXunServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ToGuWenChaXunServlet() {
		super();
...
//				System.out.println(chengshiStr+"---"+pinpaiStr+"---"+zhuanguiStr+"---"+begintimeStr+"---"+overtimeStr);
		...
		if ("".equals(chengshiStr) || "".equals(pinpaiStr) || "".equals(zhuanguiStr)
			...
			PageHelperDataResult result = sus.getAllPingjiajiluOfGuWenChaXun(page, rows, sql);
			...
			String sql = "select * from pingjiajilu " + "where chengShi='" + chengshi + "' and pinPai='" + pinpai
					+ "' and zhuanGui='" + zhuangui + "' and createTime>='" + begintime + " 00:00:00' and createTime<='"
					+ overtime + " 23:59:59' group by renyuanmc";
