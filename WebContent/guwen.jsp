...
<div class="main">
  <div class="guwen">
    <form action="ToGuWenChaXunServlet" method="post">
...
<c:if test="${not empty pageHelper.rows}">
	...
	<div id="pagehelper" align="center">
		...
		<c:if test="${requestScope.pageHelper.currentPage>1}">
			<a href="PageHelperServlet?Source=2&currentPage=1">首页</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="PageHelperServlet?Source=2&currentPage=${requestScope.pageHelper.currentPage-1}">上一页</a>
		</c:if>
		&nbsp;&nbsp;&nbsp;&nbsp; 第${requestScope.pageHelper.currentPage}页
		&nbsp;&nbsp;&nbsp;&nbsp;
		<c:if
			test="${requestScope.pageHelper.currentPage<requestScope.pageHelper.totalPage}">
			<a href="PageHelperServlet?Source=2&currentPage=${requestScope.pageHelper.currentPage+1}">下一页</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="PageHelperServlet?Source=2&currentPage=${requestScope.pageHelper.totalPage}">尾页</a>
		</c:if>
		&nbsp;&nbsp;&nbsp;&nbsp;
