...
<div class="main">
  <div class="mingxi">
    <form action="ToGuWenMingXiChaXunServlet" method="post">
	...
	<table id="pjTab" border="0" align="center" width="70%">
		...
		<c:forEach items="${pageHelper.rows}" var="ph" varStatus="idx">
			<tr align="center">
				...
				<td><a href="WeiZhiServlet?jingDu=${ph.jingdu}&weiDu=${ph.weidu}">位置</a></td>
			</tr>
		</c:forEach>
	...
	<div id="pagehelper" align="center">
		...
		<c:if test="${requestScope.pageHelper.currentPage>1}">
			<a href="PageHelperServlet?Source=1&currentPage=1">首页</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<a
				href="PageHelperServlet?Source=1&currentPage=${requestScope.pageHelper.currentPage-1}">上一页</a>
		</c:if>
		...
		<c:if
			...
			<a
				href="PageHelperServlet?Source=1&currentPage=${requestScope.pageHelper.currentPage+1}">下一页</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<a
				href="PageHelperServlet?Source=1&currentPage=${requestScope.pageHelper.totalPage}">尾页</a>
		</c:if>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<c:if
			test="${requestScope.pageHelper.currentPage==requestScope.pageHelper.totalPage}">
